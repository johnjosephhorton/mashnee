...
In this data, the average price per square foot among the comparables, excluding \PropertyName{}, is \$\MeanPricePerFoot{}/$ft^2$.
At its listed price, the price per square foot for \PropertyName{} is \$\MeanPricePerFootFocal{}/$ft^2$,
which is \MeanPricePerFootPct{}\% \ComparePricePerFoot{} than the average of the comparables.
