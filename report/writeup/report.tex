...
An insightful comparative market analysis depends on actual and substantially comparable sales. 
...
\PropertyType{} built in \PropertyYearBuilt{}, and \NumberOfComps{} selected comparable recent property sales.
...
Data from selected comparable recent sales is used to evaluate the
usefulness and reliability of each comparable sale and to analyze each
of the important attributes of the target property.
The individual and collective components of the analysis will enable parties to evaluate the price in a highly informed manner and negotiate terms with confidence.

Figure~\ref{fig:map} shows the location of the properties.
...
The report is not a ``black box''! Each component of the analysis is explained in detail. Additional information about the data and methods used are provided in Appendix~\ref{sec:methods}.


\subsection{Sale prices} 
In most cases, the listing price of a target property should be well within the range of sale prices of selected comparables.
This allows parties to compare a target property and its listing price to properties that should typically be overall more and less valuable than the target property.
